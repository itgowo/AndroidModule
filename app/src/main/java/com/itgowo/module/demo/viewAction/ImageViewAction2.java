...
public class ImageViewAction2 extends ViewAction<ImageViewAction2.ImageViewActionViewHolder, MsgEntity> {
    ...
    public RecyclerView.ViewHolder initView(Context context,Messenger<MsgEntity> messenger, ViewGroup viewGroup) {
        RecyclerView.ViewHolder holder = new ImageViewActionViewHolder(LayoutInflater.from(context).inflate(R.layout.listitem_image2, viewGroup, false));
        return holder;
    }
